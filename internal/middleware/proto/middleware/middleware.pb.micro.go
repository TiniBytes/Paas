...
type MiddlewareService interface {
	...
	DeleteMiddleType(ctx context.Context, in *MiddleTypeID, opts ...client.CallOption) (*Response, error)
...
func (c *middlewareService) DeleteMiddleType(ctx context.Context, in *MiddleTypeID, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Middleware.DeleteMiddleType", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type MiddlewareHandler interface {
	...
	DeleteMiddleType(context.Context, *MiddleTypeID, *Response) error
...
func RegisterMiddlewareHandler(s server.Server, hdlr MiddlewareHandler, opts ...server.HandlerOption) error {
	type middleware interface {
		...
		DeleteMiddleType(ctx context.Context, in *MiddleTypeID, out *Response) error
...
func (h *middlewareHandler) DeleteMiddleType(ctx context.Context, in *MiddleTypeID, out *Response) error {
	return h.MiddlewareHandler.DeleteMiddleType(ctx, in, out)
}
