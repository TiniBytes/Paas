...
var file_proto_role_role_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x58, 0x0a,
	...
	0x09, 0x0a, 0x07, 0x46, 0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x22, 0x36, 0x0a, 0x07, 0x41, 0x6c,
	...
	0x66, 0x6f, 0x22, 0x4e, 0x0a, 0x0e, 0x52, 0x6f, 0x6c, 0x65, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18,
	...
	0x20, 0x03, 0x28, 0x03, 0x52, 0x0c, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x49, 0x64, 0x32, 0xa1, 0x03, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x2b, 0x0a, 0x07, 0x41,
	...
	0x6c, 0x65, 0x49, 0x44, 0x1a, 0x0e, 0x2e, 0x72, 0x6f, 0x6c, 0x65, 0x2e, 0x52, 0x65, 0x73, 0x70,
	...
	0x6c, 0x65, 0x49, 0x44, 0x1a, 0x0e, 0x2e, 0x72, 0x6f, 0x6c, 0x65, 0x2e, 0x52, 0x6f, 0x6c, 0x65,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x10, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x14,
...
var file_proto_role_role_proto_goTypes = []interface{}{
	...
	(*RoleID)(nil),         // 1: role.RoleID
	(*Response)(nil),       // 2: role.Response
	(*FindAll)(nil),        // 3: role.FindAll
	(*AllRole)(nil),        // 4: role.AllRole
	(*RolePermission)(nil), // 5: role.RolePermission
}
var file_proto_role_role_proto_depIdxs = []int32{
	0, // 0: role.AllRole.role_info:type_name -> role.RoleInfo
	0, // 1: role.Role.AddRole:input_type -> role.RoleInfo
	1, // 2: role.Role.DeleteRole:input_type -> role.RoleID
	0, // 3: role.Role.UpdateRole:input_type -> role.RoleInfo
	1, // 4: role.Role.FindRoleByID:input_type -> role.RoleID
	3, // 5: role.Role.FindAllRole:input_type -> role.FindAll
	5, // 6: role.Role.AddPermission:input_type -> role.RolePermission
	5, // 7: role.Role.DeletePermission:input_type -> role.RolePermission
	5, // 8: role.Role.UpdatePermission:input_type -> role.RolePermission
	2, // 9: role.Role.AddRole:output_type -> role.Response
	2, // 10: role.Role.DeleteRole:output_type -> role.Response
	2, // 11: role.Role.UpdateRole:output_type -> role.Response
	0, // 12: role.Role.FindRoleByID:output_type -> role.RoleInfo
	4, // 13: role.Role.FindAllRole:output_type -> role.AllRole
	2, // 14: role.Role.AddPermission:output_type -> role.Response
	2, // 15: role.Role.DeletePermission:output_type -> role.Response
	2, // 16: role.Role.UpdatePermission:output_type -> role.Response
