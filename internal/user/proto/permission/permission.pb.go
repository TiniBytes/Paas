...
var file_proto_permission_permission_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x1a, 0x14, 0x2e, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73,
	...
	0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x50, 0x65, 0x72, 0x6d, 0x69,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x1a, 0x1a, 0x2e, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73,
...
var file_proto_permission_permission_proto_goTypes = []interface{}{
	...
	(*Response)(nil),       // 2: permission.Response
	(*FindAll)(nil),        // 3: permission.FindAll
...
var file_proto_permission_permission_proto_depIdxs = []int32{
	...
	3, // 5: permission.Permission.FindAllPermission:input_type -> permission.FindAll
	2, // 6: permission.Permission.AddPermission:output_type -> permission.Response
	2, // 7: permission.Permission.DeletePermission:output_type -> permission.Response
	2, // 8: permission.Permission.UpdatePermission:output_type -> permission.Response
